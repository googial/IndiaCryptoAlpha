...
Good luck to all agents!
    ...
    def send_leader_change_alert(
        self, old_leader: str, new_leader: str, new_leader_pnl: float
    ) -> bool:
        """
...
<b>New Leader P&L:</b> ₹{new_leader_pnl:,.2f}
    ...
    def send_race_end_alert(
        self, end_time: datetime, winner_name: str, winner_pnl: float
    ) -> bool:
        """
