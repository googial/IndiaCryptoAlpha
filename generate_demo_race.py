...
from config import LOG_LEVEL, NUM_RACE_AGENTS, RACE_DURATION_HOURS
...
def main():
    ...
    logger.info(f"Demo Race started with {demo_num_agents} agents for {demo_race_duration_hours*60:.0f} minutes.")
    ...
    try:
        ...
        while orchestrator.is_running:
            ...
            time.sleep(orchestrator.RACE_UPDATE_INTERVAL_SEC) # Wait for next update cycle
